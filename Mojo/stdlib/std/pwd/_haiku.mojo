...
"""Haiku's `struct passwd`, whose home directory and shell come before the
real name, unlike Linux's and macOS's."""
...
def _getpw_haiku(uid: UInt32) raises -> Passwd:
...
def _getpw_haiku(var name: String) raises -> Passwd:
    var passwd_ptr = external_call[
